...
public class ManejadorBD
{
	...
	private ManejadorBD() throws DatabaseException
	{
		try
		{
	         ...
	         */
	        m_conexion = DriverManager.getConnection(protocol + m_nombreBD , props);
	...
	/**
	 * El metodo finalize se sobre-escribe para cerrar la conexiÃ³n y apagar la base de datos cuando
